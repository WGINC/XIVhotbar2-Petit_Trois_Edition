...
local PANEL_THEMES = {
  ...
  -- PlayOnline wallpapers, real, exported PNGs from PlayOnline Viewer.
  -- Drop each named category folder from PlayOnline_Wallpapers/ directly under
  -- images/ (e.g. images/Final Fantasy XI/, images/SaGa Series/, ...), keeping
  -- the original filenames exactly as exported, no renaming needed.
  -- FFXI wallpapers
  {key='xi_box_art', label='XI: Box', path='Final Fantasy XI/FINAL FANTASY XI BOX ART [wp_ffxi_000]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_cg_art', label='XI: CG Art', path='Final Fantasy XI/FINAL FANTASY XI CG ART [wp_ffxi_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_logo', label='XI: Logo', path='Final Fantasy XI/FINAL FANTASY XI LOGO [wp_ffxi_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_roz', label='XI: RoZ', path='Final Fantasy XI/FINAL FANTASY XI RISE OF THE ZILART [wp_ffxi_021]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_elvaan_1', label='XI: Elvaan1', path='Final Fantasy XI/FINAL FANTASY XI ELVAAN 1 [wp_ffxi_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_elvaan_2', label='XI: Elvaan2', path='Final Fantasy XI/FINAL FANTASY XI ELVAAN 2 [wp_ffxi_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_galka', label='XI: Galka', path='Final Fantasy XI/FINAL FANTASY XI GALKA [wp_ffxi_008]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_hume_1', label='XI: Hume 1', path='Final Fantasy XI/FINAL FANTASY XI HUME 1 [wp_ffxi_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_hume_2', label='XI: Hume 2', path='Final Fantasy XI/FINAL FANTASY XI HUME 2 [wp_ffxi_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_mithra', label='XI: Mithra', path='Final Fantasy XI/FINAL FANTASY XI MITHRA [wp_ffxi_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_tarutaru_1', label='XI: Taru 1', path='Final Fantasy XI/FINAL FANTASY XI TARUTARU 1 [wp_ffxi_009]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_tarutaru_2', label='XI: Taru 2', path='Final Fantasy XI/FINAL FANTASY XI TARUTARU 2 [wp_ffxi_010]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_image_1', label='XI: Image 1', path='Final Fantasy XI/FINAL FANTASY XI Image 1 [wp_ffxi_022]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_image_2', label='XI: Image 2', path='Final Fantasy XI/FINAL FANTASY XI Image 2 [wp_ffxi_023]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_image_3', label='XI: Image 3', path='Final Fantasy XI/FINAL FANTASY XI Image 3 [wp_ffxi_024]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_image_4', label='XI: Image 4', path='Final Fantasy XI/FINAL FANTASY XI Image 4 [wp_ffxi_025]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_image_5', label='XI: Image 5', path='Final Fantasy XI/FINAL FANTASY XI Image 5 [wp_ffxi_026]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_1', label='XI: Open. 1', path='Final Fantasy XI/FINAL FANTASY XI OPENING 1 [wp_ffxi_011]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_2', label='XI: Open. 2', path='Final Fantasy XI/FINAL FANTASY XI OPENING 2 [wp_ffxi_012]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_3', label='XI: Open. 3', path='Final Fantasy XI/FINAL FANTASY XI OPENING 3 [wp_ffxi_013]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_4', label='XI: Open. 4', path='Final Fantasy XI/FINAL FANTASY XI OPENING 4 [wp_ffxi_014]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_5', label='XI: Open. 5', path='Final Fantasy XI/FINAL FANTASY XI OPENING 5 [wp_ffxi_015]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_6', label='XI: Open. 6', path='Final Fantasy XI/FINAL FANTASY XI OPENING 6 [wp_ffxi_016]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_7', label='XI: Open. 7', path='Final Fantasy XI/FINAL FANTASY XI OPENING 7 [wp_ffxi_017]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_8', label='XI: Open. 8', path='Final Fantasy XI/FINAL FANTASY XI OPENING 8 [wp_ffxi_018]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_9', label='XI: Open. 9', path='Final Fantasy XI/FINAL FANTASY XI OPENING 9 [wp_ffxi_019]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='xi_op_10', label='XI: Open.10', path='Final Fantasy XI/FINAL FANTASY XI OPENING 10 [wp_ffxi_020]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Chocobo
  {key='chocobo_1', label='Chocobo 1', path='Chocobo/Chocobo 1 [wp_pol_005]', r=255,g=255,b=255,a=180,fr=22,fg=14,fb=5},
  {key='chocobo_2', label='Chocobo 2', path='Chocobo/Chocobo 2 [wp_pol_006]', r=255,g=255,b=255,a=180,fr=22,fg=14,fb=5},
  {key='chocobo_3', label='Chocobo 3', path='Chocobo/Chocobo 3 [wp_pol_007]', r=255,g=255,b=255,a=180,fr=22,fg=14,fb=5},
  -- FFVII: Advent Children
  {key='ffvii_ac_1', label='AC: 1', path='Final Fantasy VII - Advent Children/FINAL FANTASY VII ADVENT CHILDREN 1 [wp_ffviiac_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffvii_ac_2', label='AC: 2', path='Final Fantasy VII - Advent Children/FINAL FANTASY VII ADVENT CHILDREN 2 [wp_ffviiac_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffvii_ac_3', label='AC: 3', path='Final Fantasy VII - Advent Children/FINAL FANTASY VII ADVENT CHILDREN 3 [wp_ffviiac_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffvii_ac_4', label='AC: 4', path='Final Fantasy VII - Advent Children/FINAL FANTASY VII ADVENT CHILDREN 4 [wp_ffviiac_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffvii_ac_5', label='AC: 5', path='Final Fantasy VII - Advent Children/FINAL FANTASY VII ADVENT CHILDREN 5 [wp_ffviiac_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffvii_ac_6', label='AC: 6', path='Final Fantasy VII - Advent Children/FINAL FANTASY VII ADVENT CHILDREN 6 [wp_ffviiac_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- FFXII
  {key='ffxii_ashe', label='XII: Ashe', path='Final Fantasy XII/FINAL FANTASY XII Ashe [wp_ffxii_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffxii_balflear', label='XII: Balfl.', path='Final Fantasy XII/FINAL FANTASY XII Balflear [wp_ffxii_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffxii_basch', label='XII: Basch', path='Final Fantasy XII/FINAL FANTASY XII Basch [wp_ffxii_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffxii_fran', label='XII: Fran', path='Final Fantasy XII/FINAL FANTASY XII Fran [wp_ffxii_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffxii_penelo', label='XII: Penelo', path='Final Fantasy XII/FINAL FANTASY XII Penelo [wp_ffxii_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffxii_vaan', label='XII: Vaan', path='Final Fantasy XII/FINAL FANTASY XII Vaan [wp_ffxii_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Crystal Chronicles
  {key='ffxc_1', label='CrysChron 1', path='Other/FINAL FANTASY CRYSTAL CHRONICLES 1 [wp_ffcc_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffxc_2', label='CrysChron 2', path='Other/FINAL FANTASY CRYSTAL CHRONICLES 2 [wp_ffcc_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- FFX-2 (named)
  {key='ffx2_yuna_1', label='X2: Yuna 1', path='Final Fantasy X-2/FINAL FANTASY X-2 YUNA 1 [wp_ffx-2_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_yuna_2', label='X2: Yuna 2', path='Final Fantasy X-2/FINAL FANTASY X-2 YUNA 2 [wp_ffx-2_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_yuna_3', label='X2: Yuna 3', path='Final Fantasy X-2/FINAL FANTASY X-2 YUNA 3 [wp_ffx-2_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_rikku_1', label='X2: Rikku 1', path='Final Fantasy X-2/FINAL FANTASY X-2 RIKKU 1 [wp_ffx-2_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_rikku_2', label='X2: Rikku 2', path='Final Fantasy X-2/FINAL FANTASY X-2 RIKKU 2 [wp_ffx-2_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_rikku_3', label='X2: Rikku 3', path='Final Fantasy X-2/FINAL FANTASY X-2 RIKKU 3 [wp_ffx-2_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_paine_1', label='X2: Paine 1', path='Final Fantasy X-2/FINAL FANTASY X-2 PAINE 1 [wp_ffx-2_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_paine_2', label='X2: Paine 2', path='Final Fantasy X-2/FINAL FANTASY X-2 PAINE 2 [wp_ffx-2_008]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_paine_3', label='X2: Paine 3', path='Final Fantasy X-2/FINAL FANTASY X-2 PAINE 3 [wp_ffx-2_009]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_yrp', label='X2: YRP', path='Final Fantasy X-2/FINAL FANTASY X-2 YRP [wp_ffx-2_010]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_nooj', label='X2: Nooj', path='Final Fantasy X-2/FINAL FANTASY X-2 NOOJ [wp_ffx-2_011]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_guys', label='X2: Guys', path='Final Fantasy X-2/FINAL FANTASY X-2 GUYS [wp_ffx-2_012]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_yuna_lenne', label='X2: Yuna&Lenne', path='Final Fantasy X-2/FINAL FANTASY X-2 YUNA & LENNE [wp_ffx-2_013]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_lenne', label='X2: Lenne', path='Final Fantasy X-2/FINAL FANTASY X-2 LENNE [wp_ffx-2_014]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_lenne_shuyin', label='X2: Lenne&Shuy.', path='Final Fantasy X-2/FINAL FANTASY X-2 LENNE & SHUYIN [wp_ffx-2_015]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_shuyin', label='X2: Shuyin', path='Final Fantasy X-2/FINAL FANTASY X-2 SHUYIN [wp_ffx-2_016]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- FFX-2 (alternate crops, unnamed in export)
  {key='ffx2_alt_001', label='X2: Yuna 1B', path='Final Fantasy X-2/wp_ffx-2_001', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_002', label='X2: Yuna 2B', path='Final Fantasy X-2/wp_ffx-2_002', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_003', label='X2: Yuna 3B', path='Final Fantasy X-2/wp_ffx-2_003', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_004', label='X2: Rikku 1B', path='Final Fantasy X-2/wp_ffx-2_004', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_005', label='X2: Rikku 2B', path='Final Fantasy X-2/wp_ffx-2_005', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_006', label='X2: Rikku 3B', path='Final Fantasy X-2/wp_ffx-2_006', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_007', label='X2: Paine 1B', path='Final Fantasy X-2/wp_ffx-2_007', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_008', label='X2: Paine 2B', path='Final Fantasy X-2/wp_ffx-2_008', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_009', label='X2: Paine 3B', path='Final Fantasy X-2/wp_ffx-2_009', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_010', label='X2: YRP B', path='Final Fantasy X-2/wp_ffx-2_010', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_011', label='X2: Nooj B', path='Final Fantasy X-2/wp_ffx-2_011', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_012', label='X2: Guys B', path='Final Fantasy X-2/wp_ffx-2_012', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_013', label='X2: Yuna&Lenne B', path='Final Fantasy X-2/wp_ffx-2_013', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_014', label='X2: Lenne B', path='Final Fantasy X-2/wp_ffx-2_014', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_015', label='X2: Lenne&Shuy. B', path='Final Fantasy X-2/wp_ffx-2_015', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='ffx2_alt_016', label='X2: Shuyin B', path='Final Fantasy X-2/wp_ffx-2_016', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: Romancing SaGa (Minstrel Song)
  {key='saga_ms_albert', label='RS MS: Albert', path='SaGa Series/Romancing SaGa MS ALBERT [wp_ms_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_aisha', label='RS MS: Aisha', path='SaGa Series/Romancing SaGa MS AISHA [wp_ms_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_jamil', label='RS MS: Jamil', path='SaGa Series/Romancing SaGa MS JAMIL [wp_ms_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_claudia', label='RS MS: Claudia', path='SaGa Series/Romancing SaGa MS CLAUDIA [wp_ms_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_hawk', label='RS MS: Hawk', path='SaGa Series/Romancing SaGa MS HAWK [wp_ms_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_sif', label='RS MS: Sif', path='SaGa Series/Romancing SaGa MS SIF [wp_ms_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_gray', label='RS MS: Gray', path='SaGa Series/Romancing SaGa MS GRAY [wp_ms_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_ms_barbara', label='RS MS: Barbara', path='SaGa Series/Romancing SaGa MS BARBARA [wp_ms_008]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: Romancing Sa・Ga (1)
  {key='saga_rs1_img1', label='RSaga1: Img1', path='SaGa Series/Romancing Sa・Ga Image 1 [wp_rs_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_rs1_img2', label='RSaga1: Img2', path='SaGa Series/Romancing Sa・Ga Image 2 [wp_rs_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_rs1_img3', label='RSaga1: Img3', path='SaGa Series/Romancing Sa・Ga Image 3 [wp_rs_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: Romancing Sa・Ga 2
  {key='saga_rs2_img1', label='RSaga2: Img1', path='SaGa Series/Romancing Sa・Ga 2 Image 1 [wp_rs_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_rs2_img2', label='RSaga2: Img2', path='SaGa Series/Romancing Sa・Ga 2 Image 2 [wp_rs_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: Romancing Sa・Ga 3
  {key='saga_rs3_img1', label='RSaga3: Img1', path='SaGa Series/Romancing Sa・Ga 3 Image 1 [wp_rs_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_rs3_img2', label='RSaga3: Img2', path='SaGa Series/Romancing Sa・Ga 3 Image 2 [wp_rs_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: SaGa Frontier
  {key='saga_sf_blue', label='SFront: Blue', path='SaGa Series/SaGa Frontier Blue [wp_sf_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf_coon', label='SFront: Coon', path='SaGa Series/SaGa Frontier Coon [wp_sf_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf_t260g', label='SFront: T260G', path='SaGa Series/SaGa Frontier T260G [wp_sf_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf_red', label='SFront: Red', path='SaGa Series/SaGa Frontier Red [wp_sf_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf_asellus', label='SFront: Asellus', path='SaGa Series/SaGa Frontier Asellus [wp_sf_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf_emilia', label='SFront: Emilia', path='SaGa Series/SaGa Frontier Emilia [wp_sf_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf_lute', label='SFront: Lute', path='SaGa Series/SaGa Frontier Lute [wp_sf_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: SaGa Frontier 2
  {key='saga_sf2_img1', label='SFront2: Img1', path='SaGa Series/SaGa Frontier 2 Image 1 [wp_sf_008]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf2_img2', label='SFront2: Img2', path='SaGa Series/SaGa Frontier 2 Image 2 [wp_sf_009]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf2_img3', label='SFront2: Img3', path='SaGa Series/SaGa Frontier 2 Image 3 [wp_sf_010]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_sf2_img4', label='SFront2: Img4', path='SaGa Series/SaGa Frontier 2 Image 4 [wp_sf_011]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- SaGa: Unlimited SaGa
  {key='saga_us_laura', label='USaga: Laura', path='SaGa Series/UNLIMITED SaGa Laura [wp_us_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_us_vent', label='USaga: Vent', path='SaGa Series/UNLIMITED SaGa Vent [wp_us_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_us_ruby', label='USaga: Ruby', path='SaGa Series/UNLIMITED SaGa Ruby [wp_us_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_us_armic', label='USaga: Armic', path='SaGa Series/UNLIMITED SaGa Armic [wp_us_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_us_myth', label='USaga: Myth', path='SaGa Series/UNLIMITED SaGa Myth [wp_us_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_us_cash', label='USaga: Cash', path='SaGa Series/UNLIMITED SaGa Cash [wp_us_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='saga_us_judy', label='USaga: Judy', path='SaGa Series/UNLIMITED SaGa Judy [wp_us_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Mana Series: Sword of Mana
  {key='mana_som_hero', label='SoM: Hero', path='Mana Series/SWORD of MANA Hero [wp_sk_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='mana_som_heroine', label='SoM: Heroine', path='Mana Series/SWORD of MANA Heroine [wp_sk_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='mana_som_img1', label='SoM: Img 1', path='Mana Series/SWORD of MANA Image 1 [wp_sk_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='mana_som_img2', label='SoM: Img 2', path='Mana Series/SWORD of MANA Image 2 [wp_sk_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Radiata Stories
  {key='radiata_img1', label='Radiata: Img1', path='Radiata Stories/RADIATA STORIES Image 1 [wp_radi_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='radiata_jack', label='Radiata: Jack', path='Radiata Stories/RADIATA STORIES Jack [wp_radi_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='radiata_ridley', label='Radiata: Ridley', path='Radiata Stories/RADIATA STORIES Ridley [wp_radi_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Tetra Master
  {key='tetra_1', label='Tetra 1', path='Tetra Master/TETRAMASTER 1 [wp_tm_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='tetra_2', label='Tetra 2', path='Tetra Master/TETRAMASTER 2 [wp_tm_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='tetra_3', label='Tetra 3', path='Tetra Master/TETRAMASTER 3 [wp_tm_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Hanjuku Hero 4
  {key='hanjuku_atashi_1', label='Hanjuku: Atashi', path='Hanjuku Hero 4/HANJYUKU_VS_3D_ATASHI_1 [wp_hh_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='hanjuku_img1', label='Hanjuku: Img1', path='Hanjuku Hero 4/HANJYUKU_VS_3D_IMAGE_1 [wp_hh_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='hanjuku_img2', label='Hanjuku: Img2', path='Hanjuku Hero 4/HANJYUKU_VS_3D_IMAGE_2 [wp_hh_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- System Wallpapers
  {key='sys_blackscreen', label='Sys: Black', path='System Wallpapers/BlackScreen.001', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='sys_bluecrystal', label='Sys: BlueCrys.', path='System Wallpapers/BlueCrystal [wp_pol_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  -- Other: Fantasy Earth / Front Mission / Natsumi / misc
  {key='fe_1', label='FE: 1', path='Other/FANTASY EARTH 1 [wp_fe_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fe_2', label='FE: 2', path='Other/FANTASY EARTH 2 [wp_fe_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fe_3', label='FE: 3', path='Other/FANTASY EARTH 3 [wp_fe_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fe_4', label='FE: 4', path='Other/FANTASY EARTH 4 [wp_fe_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fe_5', label='FE: 5', path='Other/FANTASY EARTH 5 [wp_fe_005]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fe_6', label='FE: 6', path='Other/FANTASY EARTH 6 [wp_fe_006]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fe_7', label='FE: 7', path='Other/FANTASY EARTH 7 [wp_fe_007]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fmo_1', label='FMO: Img 1', path='Other/FRONT MISSION ONLINE Image 1 [wp_fmo_001]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fmo_2', label='FMO: Img 2', path='Other/FRONT MISSION ONLINE Image 2 [wp_fmo_002]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fmo_3', label='FMO: Img 3', path='Other/FRONT MISSION ONLINE Image 3 [wp_fmo_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='fmo_4', label='FMO: Img 4', path='Other/FRONT MISSION ONLINE Image 4 [wp_fmo_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='natsumi_1', label='Natsumi 1', path='Other/NATSUMI_1 [wp_pol_008]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='natsumi_2', label='Natsumi 2', path='Other/NATSUMI_2 [wp_pol_009]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='natsumi_3', label='Natsumi 3', path='Other/NATSUMI_3 [wp_pol_010]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='corkboard', label='CorkBoard', path='Other/CorkBoard [wp_pol_003]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
  {key='star', label='STAR', path='Other/STAR [wp_pol_004]', r=255,g=255,b=255,a=180,fr=255,fg=255,fb=255},
}
