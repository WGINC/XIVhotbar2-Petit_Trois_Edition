...
xivhotbar_keybinds_job['Base'] = {
  ...
  --------------------------------------------------------------------------------------
  { 'battle 4 10', 'ma', 'Protect',          'stpc',  'Protect' },
  { 'battle 4 10', 'ma', 'Protect II',       'stpc',  'Protect2' },
  { 'battle 4 10', 'ma', 'Protect III',      'stpc',  'Protect3' },
  { 'battle 4 10', 'ma', 'Protect IV',       'stpc',  'Protect4' },
  { 'battle 4 10', 'ma', 'Protect V',        'stpc',  'Protect5' },
  --------------------------------------------------------------------------------------
  ...
  --{'battle 6 11', '', '', '', ''},
  --{'battle 6 12', '', '', '', ''},
	{'b 7 1', 'ws', "Cataclysm", 't', "Catc"},
	{'b 7 9', 'ma', 'Valaineral', 'me', 'Valn'},
	{'b 7 10', 'ma', 'Yoran-Oran (UC)', 'me', 'Yorn-O'},
	{'b 7 11', 'ma', 'Shantotto II', 'me', 'ShanII'},
	{'b 7 7', 'ja', "Flee", 'me', "Fle"},
	{'b 7 8', 'ma', 'Zeid II', 'me', 'ZedII'},
	{'b 7 1', 'ma', "Stonega II", 't', "StonII"},
	{'b 7 5', 'ma', "Blind", 't', "Blin"},
	{'b 7 3', 'ma', "Barparalyze", 'me', "Barp"},
	{'b 7 2', 'ma', "Firaga", 't', "Firg"},
	{'b 7 4', 'ma', "Dispel", 't', "Disp"},
	{'b 3 1', 'ma', "Dia III", 't', "DiII"},
	{'b 3 9', 'ma', "Distract", 't', "Dist"},
	{'b 3 3', 'ma', "Slow II", 't', "SlowII"},
	{'b 3 2', 'ma', "Paralyze II", 't', "ParlII"},
	{'b 2 9', 'ma', "Refresh", 'stpc', "Refr"},
	{'b 7 6', 'ma', "Barpetrify", 'me', "Barp"},
	{'b 7 12', 'ma', "Qultada", 'me', "Qult"},
	{'b 5 11', 'ja', "Steal", 't', "Stel"},
	{'b 5 10', 'ja', "Mug", 't', "Mug"},
	{'b 5 9', 'ja', "Hide", 'me', "Hid"},
}
...
xivhotbar_keybinds_job['Dark Arts'] = {
  ...
  { 'battle 1 1',  'ma', 'Stone III',    't', 'Stone3' },
...
xivhotbar_keybinds_job['RDM'] = {
  ...
  { 'battle 7 1',  'ma', 'Enstone', 'me',     'Enstone' },
